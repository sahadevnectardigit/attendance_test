...
// class OldLedgerPage extends StatefulWidget {
...
// class _OldLedgerPageState extends State<LedgerPage> {
//   int? selectedYear;
//   int? selectedMonth;
...
//     int tempYear =
//         selectedYear ?? 2082; // Default to the year in your API response
//     int tempMonth =
//         selectedMonth ?? 3; // Default to the month in your API response

//     final int startYear = 2060;
//     final int endYear = 2085;
...
//   void initState() {
//     super.initState();
//     // Initialize with the year and month from the API response
//     selectedYear = 2082;
//     selectedMonth = 3;
//     selectedStringMonth = nepaliMonths[2]; // Chaitra is at index 2 (month 3)
...
//     if (maxDay == 0) maxDay = 32; // Based on your API response
...
//               ),
//               itemCount: maxDay + 7, // Add 7 for weekday offset
//               itemBuilder: (context, index) {
//                 if (index < 7) {
//                   // First row - determine offset based on the first day of the month
//                   // For simplicity, we'll just show empty cells
//                   return Container();
//                 }

//                 int dayNumber = index - 6; // Adjust for 7-day offset
