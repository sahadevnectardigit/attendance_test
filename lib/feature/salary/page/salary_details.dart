...
class _SalaryDetailsState extends State<SalaryDetails> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          // Updated to show both English and Nepali months
          '${widget.data?.displaySalaryMonth ?? ""} Salary',
          style: TextStyle(
            ...
            children: [
              ...
              _buildInfoCard(
                ...
                children: [
                  ...
                  _infoRow(
                    ...
                    widget.data?.displaySalaryMonth,
              ...
              _buildInfoCard(
                ...
                children: [
                  ...
                  // Updated to show both English and Nepali dates
                  if (widget.data?.paymentDate != null)
                    _infoRow(
                      "Payment Date",
                      widget.data?.displayPaymentDate,
                      Icons.date_range,
                    ),
                  _infoRow(
